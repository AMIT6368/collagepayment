...
<html lang="en">
	<head>
		...
		<title>Booking | University Booking</title>
		
		<!-- Favicons -->
		<link type="image/x-icon" href="public/frontend/assets/img/home14/favicon.png" rel="icon">
		...
		<!-- Datetimepicker CSS -->
	    <link rel="stylesheet" href="public/frontend/assets/css/bootstrap-datetimepicker.min.css">

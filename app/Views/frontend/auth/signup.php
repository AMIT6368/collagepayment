                ...
                <div class="account-content">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-7 col-lg-6 login-left">
                            <img src="public/upload/auth/manage-your-everything-image.png" class="img-fluid" alt="Dreampa Register">	
                        </div>
                        <div class="col-md-12 col-lg-6 login-right">
                            ...
                            <div class="form-group form-focus">
                                ...
                                <div class="form-group form-focus">
                                    ...
                                    <label style="margin-top: -13px !important;" class="focus-label">Date of Birth</label>
                                </div>

                                <div class="form-group form-focus">
                                    <input type="email" placeholder="Reg No./ Email / Reference No. / Mobile No." class="form-control floating">
                                    <label class="focus-label">Reg No. / Reference No. </label>
                                </div>
                                ...
                                <div class="text-end">
                                    <a class="forgot-link" href="<?php echo base_url('signin') ?>">Already have an account?</a>
                                </div>
                                <button class="btn book-btn btn-block  login-btn w-100" type="submit">Register Now</button>
                                <div class="login-or">
